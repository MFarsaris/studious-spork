...
function getPrices(taxBoolean) {
    for (let dish in dishData){
        let finalPrice = 0;
        if (taxBoolean == true) {
            finalPrice = dishData[dish]['price'] * tax; 
        /* gia na parw to 'price' apo to object mesa sto array apo objects prepei na parw apo to dishData thn metablhth
        ths loop [dish] h opoia tha looparei ola ta object mesa sthn dishData 
        */
